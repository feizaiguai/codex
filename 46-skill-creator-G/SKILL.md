---
name: 46-skill-creator-G
description: Use when creating a new skill or updating an existing skill definition and you need guidance on skill structure and resources.
---
...
- **Example**: `rotate_pdf.py` for PDF rotation tasks
...
- **Examples**: `logo.png` for brand assets, `slides.pptx` for PowerPoint templates, `frontend-template/` for HTML/React boilerplate, `font.ttf` for typography
...
2. A `rotate_pdf.py` script would be helpful to store in the skill

Example: When designing a `frontend-webapp-builder` skill for queries like "Build me a todo app" or "Build me a dashboard to track my steps," the analysis shows:

1. Writing a frontend webapp requires the same boilerplate HTML/React each time
2. An `hello-world/` template containing the boilerplate HTML/React project files would be helpful to store in the skill

Example: When building a `big-query` skill to handle queries like "How many users have logged in today?" the analysis shows:

1. Querying BigQuery requires re-discovering the table schemas and relationships each time
2. A `schema.md` file documenting the table schemas would be helpful to store in the skill
